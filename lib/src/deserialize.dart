  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'OrganizationData':
          return OrganizationData.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrganizationListResponse':
          return OrganizationListResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrganizationListResponseMeta':
          return OrganizationListResponseMeta.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrganizationResponse':
          return OrganizationResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrganizationSorting':
          
          
        case 'OrganizationUserRelationshipData':
          return OrganizationUserRelationshipData.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrganizationUserRelationshipListResponse':
          return OrganizationUserRelationshipListResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrganizationUserRelationshipListResponseMeta':
          return OrganizationUserRelationshipListResponseMeta.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrganizationUserRelationshipResponse':
          return OrganizationUserRelationshipResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrganizationUserRelationshipRole':
          
          
        case 'OrganizationUserRelationshipSorting':
          
          
        case 'OrganizationUserRelationshipStatus':
