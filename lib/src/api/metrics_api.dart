...
class MetricsApi {
  ...
  /// * [names] 
  /// * [offset] 
  /// * [sort] - Allowed values: id, name, memberIdentifier, employeeRole, pinCode
  /// * [apiVersion] 
  ///
  ...
  ///
  /// Returns a [Future]
  Future<void> facilityRelationshipNovaStaffCreate({ 
    required String email,
    required String employeeRole,
    String? apiVersion,
  }) async {
    final _path = r'/facility/relationship/nova/staff';
    final _action = 'facilityRelationship:novaStaffCreate';
    final _method = r'POST';
  ...
  Future<StrengthMachineDataSetResponse> workoutSetCreate({ 
    ...
    final _bodyParameters = <String, dynamic>{
      ...
      r'userId': _encodeQueryParameter(userId),
      r'setNumber': _encodeQueryParameter(setNumber),
      r'startedAt': _encodeQueryParameter(startedAt),
