...
import 'package:keiser_metrics_sdk/src/model/organization_list_response.dart';
import 'package:keiser_metrics_sdk/src/model/organization_response.dart';
import 'package:keiser_metrics_sdk/src/model/organization_user_relationship_list_response.dart';
import 'package:keiser_metrics_sdk/src/model/organization_user_relationship_response.dart';
...
class MetricsApi {
  ...
  Future<OrganizationResponse> organizationCreate({ 
    required String names,
    String? hubspotCompanyId,
    String? apiVersion,
  }) async {
    final _path = r'/organization';
    final _action = 'organization:create';
    final _method = r'POST';
    ...
    final _queryParameters = <String, dynamic>{
      if (hubspotCompanyId != null) r'hubspotCompanyId': _encodeQueryParameter(hubspotCompanyId),
      r'name': _encodeQueryParameter(names),
      if (apiVersion != null) r'apiVersion': _encodeQueryParameter(apiVersion),
    };
    final _response = await connection.action(
    ...
    final OrganizationResponse _responseData = deserialize<OrganizationResponse, OrganizationResponse>(_response.data!, 'OrganizationResponse', growable: true);
    return _responseData;
  ...
  /// * [names] 
  /// * [offset] 
  /// * [sort] - Allowed values: id, name, createdAt
  /// * [apiVersion] 
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizationListResponse] as data
  Future<OrganizationListResponse> organizationList({ 
    bool? ascending = true,
    num? limit,
    String? names,
    num? offset,
    ...
    final _path = r'/organization/list';
    final _action = 'organization:list';
    final _method = r'GET';
    ...
    final OrganizationListResponse _responseData = deserialize<OrganizationListResponse, OrganizationListResponse>(_response.data!, 'OrganizationListResponse', growable: true);
    return _responseData;
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizationResponse] as data
  Future<OrganizationResponse> organizationShow({ 
    required num id,
    String? apiVersion,
  }) async {
    final _path = r'/organization';
    final _action = 'organization:show';
    final _method = r'GET';
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizationResponse] as data
  Future<OrganizationResponse> organizationUpdate({ 
    required num id,
    required String names,
    String? hubspotCompanyId,
    String? apiVersion,
  }) async {
    final _path = r'/organization/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _action = 'organization:update';
    final _method = r'PUT';
  ...
  ///
  /// Returns a [Future]
  Future<void> organizationUserRelationshipOrganizationDelete({ 
    required num id,
    String? apiVersion,
  }) async {
    final _path = r'/organization/relationship/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _action = 'organizationUserRelationship:organizationDelete';
    final _method = r'DELETE';
  ...
  /// * [names] 
  /// * [offset] 
  /// * [role] - Allowed values: guest, member, trainer, admin
  /// * [sort] - Allowed values: id, name, firstName, lastName, role, status
  /// * [status] - Allowed values: pending, active
  /// * [apiVersion] 
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizationUserRelationshipListResponse] as data
  Future<OrganizationUserRelationshipListResponse> organizationUserRelationshipOrganizationList({ 
    bool? ascending = true,
    bool? deactivated,
    num? limit,
    String? names,
    ...
    final _path = r'/organization/relationship/list';
    final _action = 'organizationUserRelationship:organizationList';
    final _method = r'GET';
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (names != null) r'name': _encodeQueryParameter(names),
      if (offset != null) r'offset': _encodeQueryParameter(offset),
      if (role != null) r'role': _encodeQueryParameter(role),
      if (sort != null) r'sort': _encodeQueryParameter(sort),
      if (status != null) r'status': _encodeQueryParameter(status),
      if (apiVersion != null) r'apiVersion': _encodeQueryParameter(apiVersion),
    };
    ...
    final OrganizationUserRelationshipListResponse _responseData = deserialize<OrganizationUserRelationshipListResponse, OrganizationUserRelationshipListResponse>(_response.data!, 'OrganizationUserRelationshipListResponse', growable: true);
    return _responseData;
  ...
  /// * [apiVersion] 
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizationUserRelationshipResponse] as data
  Future<OrganizationUserRelationshipResponse> organizationUserRelationshipOrganizationShow({ 
    required num id,
    String? apiVersion,
  }) async {
    final _path = r'/organization/relationship';
    final _action = 'organizationUserRelationship:organizationShow';
    final _method = r'GET';
    ...
    final OrganizationUserRelationshipResponse _responseData = deserialize<OrganizationUserRelationshipResponse, OrganizationUserRelationshipResponse>(_response.data!, 'OrganizationUserRelationshipResponse', growable: true);
    return _responseData;
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OrganizationUserRelationshipResponse] as data
  Future<OrganizationUserRelationshipResponse> organizationUserRelationshipOrganizationUpdate({ 
    required num id,
    required String role,
    String? apiVersion,
  }) async {
    final _path = r'/organization/relationship/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _action = 'organizationUserRelationship:organizationUpdate';
    final _method = r'PUT';
