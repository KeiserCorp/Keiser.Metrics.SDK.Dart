...
class MetricsApi {
  ...
  ///
  /// Returns a [Future]
  Future<void> facilityStrengthMachineMachineStartSession({ 
    String? buildNumber,
    ...
    final _queryParameters = <String, dynamic>{
      if (buildNumber != null) r'buildNumber': _encodeQueryParameter(buildNumber),
      if (softwareVersion != null) r'softwareVersion': _encodeQueryParameter(softwareVersion),
      if (apiVersion != null) r'apiVersion': _encodeQueryParameter(apiVersion),
    };
    await connection.action(
      path: _path,
