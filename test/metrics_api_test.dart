...
void main() {
  ...
  group(MetricsApi, () {
    ...
    // 1
    //
    //Future facilityRelationshipNovaStaffCreate(String email, String employeeRole, { String apiVersion }) async
    test('test facilityRelationshipNovaStaffCreate', () async {
      // TODO
    });
    ...
    // 1
    //
    //Future facilityRelationshipNovaStaffReactivate(String email, num facilityRelationshipId, { String apiVersion }) async
    ...
    // 1
    //
    //Future<MachineClaimRegisterResponse> machineClaimRegister(String displayUUID, String firmwareVersion, String leftCylinderSerial, String machineModel, String mainBoardSerial, String softwareVersion, { String rightCylinderSerial, String apiVersion }) async
    ...
    // 1
    //
    //Future<StrengthMachineDataSetResponse> workoutSetCreate(String clientSetId, num userId, num setNumber, DateTime startedAt, MultipartFile workoutSetData, { String apiVersion, num exerciseId }) async
    ...
    // 1
    //
    //Future<StrengthMachineDataSetListResponse> workoutSetList({ bool ascending, DateTime from, num limit, num offset, String sort, num strengthMachineId, DateTime to, num userId, String apiVersion }) async
