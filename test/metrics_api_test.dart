...
void main() {
  ...
  group(MetricsApi, () {
    ...
    // 1
    //
    //Future<OrganizationResponse> organizationCreate(String names, { String hubspotCompanyId, String apiVersion }) async
    test('test organizationCreate', () async {
      // TODO
    });
    ...
    // 1
    //
    //Future<OrganizationListResponse> organizationList({ bool ascending, num limit, String names, num offset, String sort, String apiVersion }) async
    test('test organizationList', () async {
      // TODO
    });
    ...
    // 1
    //
    //Future<OrganizationResponse> organizationShow(num id, { String apiVersion }) async
    test('test organizationShow', () async {
      // TODO
    });
    ...
    // 1
    //
    //Future<OrganizationResponse> organizationUpdate(num id, String names, { String hubspotCompanyId, String apiVersion }) async
    test('test organizationUpdate', () async {
      // TODO
    });
    ...
    // 1
    //
    //Future organizationUserRelationshipOrganizationDelete(num id, { String apiVersion }) async
    test('test organizationUserRelationshipOrganizationDelete', () async {
      // TODO
    });
    ...
    // 1
    //
    //Future<OrganizationUserRelationshipListResponse> organizationUserRelationshipOrganizationList({ bool ascending, bool deactivated, num limit, String names, num offset, String role, String sort, String status, String apiVersion }) async
    test('test organizationUserRelationshipOrganizationList', () async {
      // TODO
    });
    ...
    // 1
    //
    //Future<OrganizationUserRelationshipResponse> organizationUserRelationshipOrganizationShow(num id, { String apiVersion }) async
    test('test organizationUserRelationshipOrganizationShow', () async {
      // TODO
    });
    ...
    // 1
    //
    //Future<OrganizationUserRelationshipResponse> organizationUserRelationshipOrganizationUpdate(num id, String role, { String apiVersion }) async
    test('test organizationUserRelationshipOrganizationUpdate', () async {
      // TODO
    });
