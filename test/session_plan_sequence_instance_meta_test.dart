...
// tests for SessionPlanSequenceInstanceMeta
void main() {
  final SessionPlanSequenceInstanceMeta? instance = /* SessionPlanSequenceInstanceMeta(...) */ null;
  // TODO add properties to the entity

  group(SessionPlanSequenceInstanceMeta, () {
    // String names
