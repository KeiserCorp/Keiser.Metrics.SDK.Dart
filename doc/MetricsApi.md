...
> facilityStrengthMachineMachineStartSession(buildNumber, softwareVersion, apiVersion)
...
try {
    metricsApi.facilityStrengthMachineMachineStartSession(buildNumber, softwareVersion, apiVersion);
} catch on DioError (e) {
