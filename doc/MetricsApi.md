...
[**organizationCreate**](MetricsApi.md#organizationcreate) | **POST** /organization | Create an organization
[**organizationList**](MetricsApi.md#organizationlist) | **GET** /organization/list | List organizations
[**organizationShow**](MetricsApi.md#organizationshow) | **GET** /organization | Show an organization
[**organizationUpdate**](MetricsApi.md#organizationupdate) | **PUT** /organization/{id} | Update an organization
[**organizationUserRelationshipOrganizationDelete**](MetricsApi.md#organizationuserrelationshiporganizationdelete) | **DELETE** /organization/relationship/{id} | Delete an organization&#39;s user relationship
[**organizationUserRelationshipOrganizationList**](MetricsApi.md#organizationuserrelationshiporganizationlist) | **GET** /organization/relationship/list | List an organization&#39;s user relationships
[**organizationUserRelationshipOrganizationShow**](MetricsApi.md#organizationuserrelationshiporganizationshow) | **GET** /organization/relationship | Show an organization&#39;s user relationship
[**organizationUserRelationshipOrganizationUpdate**](MetricsApi.md#organizationuserrelationshiporganizationupdate) | **PUT** /organization/relationship/{id} | Update an organization&#39;s user relationship
...
# **organizationCreate**
> OrganizationResponse organizationCreate(names, hubspotCompanyId, apiVersion)
...
final api = MetricsApi metricsApi = MetricsApi();
final String names = names_example; // String | 
final String hubspotCompanyId = hubspotCompanyId_example; // String | 
final String apiVersion = apiVersion_example; // String | 

try {
    final response = metricsApi.organizationCreate(names, hubspotCompanyId, apiVersion);
    print(response);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->organizationCreate: $e\n');
}
```
...
# **organizationList**
> OrganizationListResponse organizationList(ascending, limit, names, offset, sort, apiVersion)
...
final String names = names_example; // String | 
final num offset = 8.14; // num | 
final String sort = sort_example; // String | Allowed values: id, name, createdAt
final String apiVersion = apiVersion_example; // String | 

try {
    final response = metricsApi.organizationList(ascending, limit, names, offset, sort, apiVersion);
    print(response);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->organizationList: $e\n');
}
```
 ...
 **names** | **String**|  | [optional] 
 **offset** | **num**|  | [optional] 
 **sort** | **String**| Allowed values: id, name, createdAt | [optional] [default to 'id']
 **apiVersion** | **String**|  | [optional] 
...
# **organizationShow**
> OrganizationResponse organizationShow(id, apiVersion)
...
try {
    final response = metricsApi.organizationShow(id, apiVersion);
    print(response);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->organizationShow: $e\n');
}
```
...
# **organizationUpdate**
> OrganizationResponse organizationUpdate(id, names, hubspotCompanyId, apiVersion)
...
try {
    final response = metricsApi.organizationUpdate(id, names, hubspotCompanyId, apiVersion);
    print(response);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->organizationUpdate: $e\n');
}
```
...
# **organizationUserRelationshipOrganizationDelete**
> organizationUserRelationshipOrganizationDelete(id, apiVersion)

Delete an organization's user relationship
...
try {
    metricsApi.organizationUserRelationshipOrganizationDelete(id, apiVersion);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->organizationUserRelationshipOrganizationDelete: $e\n');
}
```
...
# **organizationUserRelationshipOrganizationList**
> OrganizationUserRelationshipListResponse organizationUserRelationshipOrganizationList(ascending, deactivated, limit, names, offset, role, sort, status, apiVersion)

List an organization's user relationships
...
final String names = names_example; // String | 
final num offset = 8.14; // num | 
final String role = role_example; // String | Allowed values: guest, member, trainer, admin
final String sort = sort_example; // String | Allowed values: id, name, firstName, lastName, role, status
final String status = status_example; // String | Allowed values: pending, active
final String apiVersion = apiVersion_example; // String | 

try {
    final response = metricsApi.organizationUserRelationshipOrganizationList(ascending, deactivated, limit, names, offset, role, sort, status, apiVersion);
    print(response);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->organizationUserRelationshipOrganizationList: $e\n');
}
```
 ...
 **names** | **String**|  | [optional] 
 **offset** | **num**|  | [optional] 
 **role** | **String**| Allowed values: guest, member, trainer, admin | [optional] 
 **sort** | **String**| Allowed values: id, name, firstName, lastName, role, status | [optional] [default to 'id']
 **status** | **String**| Allowed values: pending, active | [optional] 
 **apiVersion** | **String**|  | [optional] 

### Return type

[**OrganizationUserRelationshipListResponse**](OrganizationUserRelationshipListResponse.md)
...
# **organizationUserRelationshipOrganizationShow**
> OrganizationUserRelationshipResponse organizationUserRelationshipOrganizationShow(id, apiVersion)

Show an organization's user relationship
...
try {
    final response = metricsApi.organizationUserRelationshipOrganizationShow(id, apiVersion);
    print(response);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->organizationUserRelationshipOrganizationShow: $e\n');
}
```
...
[**OrganizationUserRelationshipResponse**](OrganizationUserRelationshipResponse.md)
...
# **organizationUserRelationshipOrganizationUpdate**
> OrganizationUserRelationshipResponse organizationUserRelationshipOrganizationUpdate(id, role, apiVersion)

Update an organization's user relationship
...
try {
    final response = metricsApi.organizationUserRelationshipOrganizationUpdate(id, role, apiVersion);
    print(response);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->organizationUserRelationshipOrganizationUpdate: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **id** | **num**|  | 
 **role** | **String**| Allowed values: guest, member, trainer, admin | 
 **apiVersion** | **String**|  | [optional] 
