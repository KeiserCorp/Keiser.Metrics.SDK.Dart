...
[**facilityRelationshipNovaStaffCreate**](MetricsApi.md#facilityrelationshipnovastaffcreate) | **POST** /facility/relationship/nova/staff | Invite a nova staff member by email
[**facilityRelationshipNovaStaffDeactivate**](MetricsApi.md#facilityrelationshipnovastaffdeactivate) | **POST** /facility/relationship/nova/staff/{facilityRelationshipId}/deactivate | Deactivate a Nova staff member
...
[**facilityRelationshipNovaStaffReactivate**](MetricsApi.md#facilityrelationshipnovastaffreactivate) | **POST** /facility/relationship/nova/staff/{facilityRelationshipId}/reactivate | Reactivate a Nova staff member
...
final String names = names_example; // String | 
final num offset = 8.14; // num | 
final String sort = sort_example; // String | Allowed values: id, name, memberIdentifier, employeeRole, pinCode
final String apiVersion = apiVersion_example; // String | 
 ...
 **names** | **String**|  | [optional] 
 **offset** | **num**|  | [optional] 
 **sort** | **String**| Allowed values: id, name, memberIdentifier, employeeRole, pinCode | [optional] [default to 'id']
 **apiVersion** | **String**|  | [optional] 
...
# **facilityRelationshipNovaStaffCreate**
> facilityRelationshipNovaStaffCreate(email, employeeRole, apiVersion)
...
try {
    metricsApi.facilityRelationshipNovaStaffCreate(email, employeeRole, apiVersion);
} catch on DioError (e) {
    print('Exception when calling MetricsApi->facilityRelationshipNovaStaffCreate: $e\n');
}
```
...
Deactivate a Nova staff member
...
> facilityRelationshipNovaStaffReactivate(email, facilityRelationshipId, apiVersion)

Reactivate a Nova staff member
...
try {
    metricsApi.facilityRelationshipNovaStaffReactivate(email, facilityRelationshipId, apiVersion);
} catch on DioError (e) {
...
> MachineClaimRegisterResponse machineClaimRegister(displayUUID, firmwareVersion, leftCylinderSerial, machineModel, mainBoardSerial, softwareVersion, rightCylinderSerial, apiVersion)
...
try {
    final response = metricsApi.machineClaimRegister(displayUUID, firmwareVersion, leftCylinderSerial, machineModel, mainBoardSerial, softwareVersion, rightCylinderSerial, apiVersion);
    print(response);
} catch on DioError (e) {
...
# **workoutSetCreate**
> StrengthMachineDataSetResponse workoutSetCreate(clientSetId, userId, setNumber, startedAt, workoutSetData, apiVersion, exerciseId)
...
try {
    final response = metricsApi.workoutSetCreate(clientSetId, userId, setNumber, startedAt, workoutSetData, apiVersion, exerciseId);
    print(response);
} catch on DioError (e) {
...
# **workoutSetList**
> StrengthMachineDataSetListResponse workoutSetList(ascending, from, limit, offset, sort, strengthMachineId, to, userId, apiVersion)
...
try {
    final response = metricsApi.workoutSetList(ascending, from, limit, offset, sort, strengthMachineId, to, userId, apiVersion);
    print(response);
} catch on DioError (e) {
